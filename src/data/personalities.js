...
export const bigFiveTypes = {
  explorer: {
    ...
    subtitle: '开放好奇 · 内敛深思',
    character: '/characters/explorer.png', color: '#9B8EC4',
  ...
  leader: {
    ...
    subtitle: '自信果断 · 目标导向',
    character: '/characters/leader.png', color: '#9B8EC4',
  ...
  mediator: {
    ...
    subtitle: '温和包容 · 善于合作',
    character: '/characters/mediator.png', color: '#89A89B',
...
export const enneagramTypes = {
  1: { id: 'type1', name: '第一型 · 完美主义者', emoji: '◈', subtitle: '追求卓越 · 原则坚定', character: '/characters/perfectionist.png', color: '#9B8EC4', traits: ['原则性强', '追求完美', '责任心重', '自律'], desc: '你是天生的改革者，内心有一把精确的尺子衡量一切。' },
  2: { id: 'type2', name: '第二型 · 助人者', emoji: '♥', subtitle: '温暖体贴 · 乐于奉献', character: '/characters/helper.png', color: '#D4B8C7', traits: ['温暖体贴', '乐于助人', '善解人意', '奉献精神'], desc: '你的心是一盏永不熄灭的灯，照亮身边每一个人。' },
  3: { id: 'type3', name: '第三型 · 成就者', emoji: '★', subtitle: '高效务实 · 目标明确', character: '/characters/achiever.png', color: '#9B8EC4', traits: ['高效务实', '目标明确', '适应力强', '善表现'], desc: '你像一颗永不停歇的星星，在追逐卓越的路上闪闪发光。' },
  4: { id: 'type4', name: '第四型 · 艺术家', emoji: '✦', subtitle: '浪漫敏感 · 独特自我', character: '/characters/artist.png', color: '#D4B8C7', traits: ['独特自我', '情感深邃', '创造力强', '审美敏锐'], desc: '你的灵魂像一幅未完成的水彩画，每一笔都是独特的情感表达。' },
  5: { id: 'type5', name: '第五型 · 观察者', emoji: '◆', subtitle: '理性冷静 · 知识渊博', character: '/characters/observer.png', color: '#89A89B', traits: ['理性冷静', '善于分析', '知识渊博', '独立思考'], desc: '你在知识的星空中遨游，用理智编织理解世界的网。' },
  6: { id: 'type6', name: '第六型 · 忠诚者', emoji: '▣', subtitle: '谨慎可靠 · 忠诚坚定', character: '/characters/loyalist.png', color: '#9B8EC4', traits: ['忠诚可靠', '谨慎细心', '危机意识', '责任心强'], desc: '你是暴风雨中最可靠的灯塔，忠诚是你最坚硬的铠甲。' },
  7: { id: 'type7', name: '第七型 · 享乐者', emoji: '★', subtitle: '乐观开朗 · 热爱生活', character: '/characters/enthusiast.png', color: '#D4B8C7', traits: ['乐观开朗', '热爱自由', '多才多艺', '精力充沛'], desc: '你的生命是一场永不落幕的嘉年华，快乐是你最自然的状态。' },
  8: { id: 'type8', name: '第八型 · 挑战者', emoji: '◆', subtitle: '坚强果断 · 保护欲强', character: '/characters/challenger.png', color: '#9B8EC4', traits: ['坚强果断', '保护欲强', '自信勇敢', '领导力'], desc: '你是风雨中的磐石，用力量守护你所珍视的一切。' },
  9: { id: 'type9', name: '第九型 · 和平者', emoji: '◈', subtitle: '平和包容 · 随遇而安', character: '/characters/peacemaker.png', color: '#89A89B', traits: ['平和包容', '回避冲突', '善解人意', '随和自然'], desc: '你是一片宁静的湖泊，在喧嚣的世界中保持内心的平和。' }
}
